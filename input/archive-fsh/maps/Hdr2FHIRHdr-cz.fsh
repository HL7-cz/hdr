...
* group[=].element[+].code = #HospitalDischargeReportCz.header
...
* group[=].element[+].code = #HospitalDischargeReportCz.body.presentedForm
...
* group[=].element[+].code = #HospitalDischargeReportCz.body.advanceDirectives
...
// A.2.2 Alerts
* group[=].element[+].code = #HospitalDischargeReportCz.body.alerts
...
// A.2.3 Encounter
* group[=].element[+].code = #HospitalDischargeReportCz.body.encounter
...
* group[=].element[+].code = #HospitalDischargeReportCz.body.admissionEvaluation
...
* group[=].element[+].code = #HospitalDischargeReportCz.body.patientHistory
...
* group[=].element[+].code = #HospitalDischargeReportCz.body.hospitalStay
...
* group[=].element[+].code = #HospitalDischargeReportCz.body.dischargeDetails
...
* group[=].element[+].code = #HospitalDischargeReportCz.body.dischargeDetails.functionalStatus
...
* group[=].element[+].code = #HospitalDischargeReportCz.body.dischargeDetails.dischargeNote
...
* group[=].element[+].code = #HospitalDischargeReportCz.body.recommendations
...
// A.2.7.1 Care plan
* group[=].element[+].code = #HospitalDischargeReportCz.body.recommendations.carePlan
...
* group[=].element[+].code = #HospitalDischargeReportCz.body.recommendations.medicationSummary
...
* group[=].element[+].code = #HospitalDischargeReportCz.body.recommendations.otherRecommendations
