...
Usage: #definition
* url = "https://hl7.cz/fhir/hdr/ConceptMap/advanceDirectives2FHIR-cz-hdr"
...
* group[=].element[+].code = #AdvanceDirectivesCz.livingWill.document
