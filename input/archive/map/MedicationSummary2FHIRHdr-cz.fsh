...
* group[=].element[+].code = #MedicationSummaryCz.productCode
...
* group[=].element[+].code = #MedicationSummaryCz.reason
...
* group[=].element[+].code = #MedicationSummaryCz.changeReason
...
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "If no details about the medication are provided"
* group[=].element[+].code = #MedicationSummaryCz.daysSupplied
...
* group[=].element[+].code = #MedicationSummaryCz.dosageRegimen
