...
* group[=].element[+].code = #AlertsCz.medicalAlertsCz.description
* group[=].element[=].display = "A.2.2.2.1 - Healthcare alert description"
* group[=].element[=].target.code = #Composition.section:sectionAlertsCz.text
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
...
* group[=].element[+].code = #AlertsCz.medicalAlertsCz.code
...
* group[=].element[+].code = #AlertsCz.medicalAlertsCz.specialistPhysician
...
* group[=].element[+].code = #AlertsCz.medicalAlertsCz.comment
...
* group[=].element[+].code = #AlertsCz.medicalAlertsCz.priority
...
* group[=].element[+].code = #AlertsCz.medicalAlertsCz.period
