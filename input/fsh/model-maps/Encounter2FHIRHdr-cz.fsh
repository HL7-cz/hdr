...
* group[=].element[+].code = #InPatientEncounterCz.admission.admitter.organizationID
...
* group[=].element[+].code = #InPatientEncounterCz.admission.referringHP.organizationID
...
* group[=].element[+].code = #InPatientEncounterCz.location.organization.identifier
...
* group[=].element[+].code = #InPatientEncounterCz.location.organization.name
* group[=].element[=].display = "A.2.3.6.3 - Organisation Part Name"
* group[=].element[=].target.code = #Organization.name
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = "Encounter.location.location.managingOrganization"
* group[=].element[+].code = #InPatientEncounterCz.location.organization.details
...
* group[=].element[+].code = #InPatientEncounterCz.admission.admitter.identifier
...
* group[=].element[+].code = #InPatientEncounterCz.admission.admitter.name
...
* group[=].element[+].code = #InPatientEncounterCz.admission.referringHP.identifier
...
* group[=].element[+].code = #InPatientEncounterCz.admission.referringHP.name
...
* group[=].element[+].code = #InPatientEncounterCz.admission.admitter.organization
...
* group[=].element[+].code = #InPatientEncounterCz.admissionReason
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #InPatientEncounterCz.admissionReason.code
* group[=].element[=].display = "A.2.3.4.1 - Admission reason"
* group[=].element[=].target.code = #Encounter.reasonCode
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #InPatientEncounterCz.admissionReason.comment
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #InPatientEncounterCz.discharge.date
* group[=].element[=].display = "A.2.3.5.1 - Discharge date"
* group[=].element[=].target.code = #Encounter.period.end
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #InPatientEncounterCz.discharge.destinationType
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #InPatientEncounterCz.discharge.destinationLocation
* group[=].element[=].display = "A.2.3.5.3 - Destination location"
* group[=].element[=].target.code = #Encounter.hospitalization.destination
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #InPatientEncounterCz.location
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #InPatientEncounterCz.location.period
...
* group[=].element[+].code = #InPatientEncounterCz.location.organization
