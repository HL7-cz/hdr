...
* prijemce 0..* Base "A.1.4 Příjemce dokumentu" """Zamýšlený příjemce propouštěcí zprávy."""
...
* overil 0..* Base "A.1.6 Ověřil" """Zdravotnický pracovník, který dokument ověřil."""
...
* zodpovida 0..1 Base "A.1.7 Zodpovídá" """Zdravotnický pracovník zodpovědný za obsah dokumentu."""
...
* metadata 1..1 Base "A.1.8 Metadata dokumentu" """Technická metadata dokumentu."""
...
* podpis 1..1 Base "A.1.9 Elektronické podpisy" """Elektronické podepsání dokumentu dle zákona."""
