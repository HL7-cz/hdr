...
* allergy.agent 1..1 CodeableConcept "A.2.2.1.2 - Agent or Allergen" """A specific allergen or other agent/substance (drug, food, chemical agent, etc.) to which the patient has an adverse reaction propensity."""
* allergy.typeOfPropensity 0..1 CodeableConcept "A.2.2.1.3 - Type of propensity" """This element describes whether this condition refers to an allergy, non-allergy intolerance, or unknown class of intolerance (not known to be allergy or intolerance)"""
* allergy.manifestation 0..* CodeableConcept "A.2.2.1.4 - Allergy manifestation" """Description of the clinical manifestation of the allergic reaction including date of manifestation and severity. Example: anaphylactic shock, angioedema (the clinical manifestation also gives information about the severity of the observed reaction). Multiple manifestations could be provided."""
...
* medicalAlerts.code 0..1 CodeableConcept "A.2.2.2.3 - Code"
* medicalAlerts.specialistPhysician 0..1 Base "A.2.2.2.4 - Specialist physician"
* medicalAlerts.comment 0..1 string "A.2.2.2.5 - Comment"
* medicalAlerts.priority 0..1 CodeableConcept "A.2.2.2.6 - Priority"
* medicalAlerts.period 0..1 Base "A.2.2.2.7 - Period"