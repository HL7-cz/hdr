...
Usage: #definition
* url = "http://hl7.cz/fhir/hdr/ConceptMap/functionalStatus2FHIR-hdr-cz"
...
* group[+].source = "http://hl7.cz/fhir/hdr/StructureDefinition/FunctionalStatusCz"
* group[=].target = "http://hl7.cz/fhir/hdr/StructureDefinition/cz-composition-hdr"
...
* group[=].element[=].target.equivalence = #relatedto
* group[+].source = "http://hl7.cz/fhir/hdr/StructureDefinition/FunctionalStatusCz"
* group[=].target = "http://hl7.cz/fhir/hdr/StructureDefinition/cz-condition-hdr"
* group[=].element[+].code = #FunctionalStatus.description
* group[=].element[=].display = "A.2.8.2.1 - Description"
