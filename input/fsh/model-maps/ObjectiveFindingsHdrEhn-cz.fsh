...
* provedl 0..* BackboneElement "A.2.8.1.2 Provedl" """...Identifikuje osobu, která vyšetření provedla nebo je zdrojem informací o výsledku vyšetření. Tato osoba nemusí být totožná s autorem dokumentu..."""
* antropometrickeUdaje 0..1 BackboneElement "A.2.8.1.3 Antropometrické údaje" """...Výsledky antropometrických měření pacienta: Požadované: výška, hmotnost, BMI (automatický výpočet z uvedených hodnot). Volitelné: obvod hlavy, hrudníku, břicha..."""
  * textVysledek 0..1 string "A.2.8.1.3.1 Výsledek vyšetření textem" """...Textový popis výsledku vyšetření..."""
  * parametrickyZaznam 0..* BackboneElement "A.2.8.1.3.2 Parametrický záznam vyšetření" """...Parametrický zápis výsledku vyšetření..."""
  ...
  * provedl 0..* BackboneElement "A.2.8.1.3.3 Provedl" """...Identifikuje osobu, která vyšetření provedla nebo je zdrojem informací o výsledku..."""
* zivotniFunkce 0..* BackboneElement "A.2.8.1.4 Základní životní funkce" """...Výsledky měření základních životních funkcí pacienta: Tepová frekvence, dechová frekvence, TK s uvedením strany měření. Volitelné: saturace O2..."""
  * textovyVysledek 0..1 string "A.2.8.1.4.1 Výsledek vyšetření textem" """...Textový popis výsledku vyšetření..."""
  * parametrickyZaznam 0..1 BackboneElement "A.2.8.1.4.2 Parametrický záznam vyšetření" """...Parametrický zápis výsledku vyšetření..."""
  ...
  * provedl 0..* BackboneElement "A.2.8.1.4.3 Provedl" """...Identifikuje osobu, která vyšetření provedla nebo je zdrojem informací o výsledku..."""
