...
* kontakt 0..1 Base "A.1.2 Kontaktní informace pacienta" """Kontaktní údaje pacienta, včetně adresy, kontaktů a preferovaného lékaře."""
  ...
  * preferovanyLekar 0..1 Base "A.1.2.3 Preferovaný lékař" """Identifikace preferovaného lékaře, u kterého je pacient evidován."""
  ...
  * kontaktniOsoba 0..* Base "A.1.2.4 Zákonný zástupce a kontaktní osoba" """Kontaktní osoba – např. zákonný zástupce nebo jiná blízká osoba."""
