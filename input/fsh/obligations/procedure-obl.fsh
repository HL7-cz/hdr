Profile: CZ_ProcedureObligationsHdr
Parent: CZ_ProcedureHdr
...
* extension[bodySite] insert OblCreator(#SHALL:populate-if-known,L3)
...
* extension[bodySite] insert OblConsumer(#SHALL:display,L3)
