...
* custodian insert OblCreator(#SHOULD:able-to-populate,L3)
...
* section[sectionVitalSigns] insert OblCreator(#SHALL:able-to-populate,L3)
* section[sectionPhysicalExamination] insert OblCreator(#SHALL:able-to-populate,L3)
* section[sectionFunctionalStatus] insert OblCreator(#SHALL:able-to-populate,L3)
...
* custodian insert OblConsumer(#SHOULD:display,L3)
...
* section[sectionVitalSigns] insert OblConsumer(#SHALL:display,L3)
* section[sectionVitalSigns].text insert OblConsumer(#SHALL:display,L3)
* section[sectionPhysicalExamination] insert OblConsumer(#SHALL:display,L3)
* section[sectionPhysicalExamination].text insert OblConsumer(#SHALL:display,L3)
* section[sectionFunctionalStatus] insert OblConsumer(#SHALL:display,L3)
* section[sectionFunctionalStatus].text insert OblConsumer(#SHALL:display,L3)
