...
* extension[information-recipient] insert OblCreator(#SHALL:populate-if-known,L1)
...
* section[sectionAttachments] insert OblCreator(#SHOULD:populate-if-known,L1)
...
* extension[information-recipient] insert OblConsumer(#SHALL:display,L1)
...
* section[sectionAttachments] insert OblConsumer(#SHALL:display,L1)
...
* identifier insert OblCreator(#SHALL:able-to-populate,L1)
* extension[information-recipient] insert OblCreator(#SHALL:populate-if-known,L2)
...
* section[sectionAdvanceDirectives].text insert OblCreator(#SHALL:able-to-populate,L2)
* section[sectionAlert].text insert OblCreator(#SHALL:able-to-populate,L2)
* section[sectionAdmissionEvaluation].text insert OblCreator(#SHALL:populate-if-known,L2)
* section[sectionPatientHx].text insert OblCreator(#SHOULD:populate-if-known,L2)
...
* section[sectionPlanOfCare].text insert OblCreator(#SHALL:able-to-populate,L2)         
...
* section[sectionAttachments] insert OblCreator(#SHOULD:populate-if-known,L2)
...
* section[sectionPhysicalExamination].text insert OblCreator(#SHALL:able-to-populate,L2)
