...
* section[sectionAdmissionEvaluation] insert OblCreator(#SHOULD:populate-if-known,L2)
* section[sectionVitalSigns].text insert OblCreator(#SHALL:able-to-populate,L2)
* section[sectionPhysicalExamination] insert OblCreator(#SHOULD:able-to-populate,L2)
...
* section[sectionFamilyHistory] insert OblCreator(#SHOULD:populate-if-known,L2)
* section[sectionSocialHistory] insert OblCreator(#SHOULD:populate-if-known,L2)
* section[sectionTravelHx] insert OblCreator(#SHOULD:populate-if-known,L2)
* section[sectionInfectiousContacts] insert OblCreator(#SHOULD:populate-if-known,L2)  
...
* section[sectionMedications] insert OblCreator(#SHALL:able-to-populate,L2)
...
* section[sectionPlanOfCare] insert OblCreator(#SHOULD:able-to-populate,L2)         
...
* section[sectionSocialHistory] insert OblConsumer(#SHALL:display,L2)
* section[sectionTravelHx] insert OblConsumer(#SHALL:display,L2)
* section[sectionInfectiousContacts] insert OblConsumer(#SHALL:display,L2)
...
* section[sectionMedications] insert OblConsumer(#SHALL:display,L2)
