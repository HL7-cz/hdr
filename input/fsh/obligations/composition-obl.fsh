...
* section[sectionHospitalCourse].section[sectionDiagnosticSummary] insert OblCreator(#SHALL:able-to-populate,L2)   
* section[sectionHospitalCourse].section[sectionSignificantProcedures] insert OblCreator(#SHALL:able-to-populate,L2)
* section[sectionHospitalCourse].section[sectionMedicalDevices] insert OblCreator(#SHALL:able-to-populate,L2)
* section[sectionHospitalCourse].section[sectionPharmacotherapy] insert OblCreator(#SHALL:able-to-populate,L2)
* section[sectionHospitalCourse].section[sectionSignificantResults] insert OblCreator(#SHALL:able-to-populate,L2)
...
* section[sectionHospitalCourse].section[sectionSynthesis] insert OblCreator(#SHALL:able-to-populate,L2)
...
* section[sectionHospitalCourse].section[sectionDiagnosticSummary] insert OblConsumer(#SHALL:display,L2)  
* section[sectionHospitalCourse].section[sectionDiagnosticSummary].text insert OblConsumer(#SHALL:display,L2)
* section[sectionHospitalCourse].section[sectionSignificantProcedures] insert OblConsumer(#SHALL:display,L2)
* section[sectionHospitalCourse].section[sectionSignificantProcedures].text insert OblConsumer(#SHALL:display,L2)
* section[sectionHospitalCourse].section[sectionMedicalDevices] insert OblConsumer(#SHALL:display,L2)
* section[sectionHospitalCourse].section[sectionMedicalDevices].text insert OblConsumer(#SHALL:display,L2)
* section[sectionHospitalCourse].section[sectionPharmacotherapy] insert OblConsumer(#SHALL:display,L2)
* section[sectionHospitalCourse].section[sectionPharmacotherapy].text insert OblConsumer(#SHALL:display,L2)
* section[sectionHospitalCourse].section[sectionSignificantResults] insert OblConsumer(#SHALL:display,L2)
* section[sectionHospitalCourse].section[sectionSignificantResults].text insert OblConsumer(#SHALL:display,L2)
...
* section[sectionHospitalCourse].section[sectionSynthesis] insert OblConsumer(#SHALL:display,L2)
* section[sectionHospitalCourse].section[sectionSynthesis].text insert OblConsumer(#SHALL:display,L2)
...
* section[sectionHospitalCourse].section[sectionDiagnosticSummary] insert OblCreator(#SHALL:able-to-populate,L3)
* section[sectionHospitalCourse].section[sectionDiagnosticSummary].text insert OblCreator(#SHALL:able-to-populate,L3)
* section[sectionHospitalCourse].section[sectionDiagnosticSummary].entry insert OblCreator(#SHALL:able-to-populate,L3)

* section[sectionHospitalCourse].section[sectionSignificantProcedures] insert OblCreator(#SHALL:able-to-populate,L3)
* section[sectionHospitalCourse].section[sectionSignificantProcedures].text insert OblCreator(#SHALL:able-to-populate,L3)
* section[sectionHospitalCourse].section[sectionSignificantProcedures].entry insert OblCreator(#SHALL:able-to-populate,L3)

* section[sectionHospitalCourse].section[sectionMedicalDevices] insert OblCreator(#SHALL:able-to-populate,L3)
* section[sectionHospitalCourse].section[sectionMedicalDevices].text insert OblCreator(#SHALL:able-to-populate,L3)
* section[sectionHospitalCourse].section[sectionMedicalDevices].entry insert OblCreator(#SHALL:able-to-populate,L3)

* section[sectionHospitalCourse].section[sectionPharmacotherapy] insert OblCreator(#SHALL:able-to-populate,L3)
* section[sectionHospitalCourse].section[sectionPharmacotherapy].text insert OblCreator(#SHALL:able-to-populate,L3)
* section[sectionHospitalCourse].section[sectionPharmacotherapy].entry insert OblCreator(#SHALL:able-to-populate,L3)

* section[sectionHospitalCourse].section[sectionSignificantResults] insert OblCreator(#SHALL:able-to-populate,L3)
* section[sectionHospitalCourse].section[sectionSignificantResults].text insert OblCreator(#SHALL:able-to-populate,L3)
* section[sectionHospitalCourse].section[sectionSignificantResults].entry insert OblCreator(#SHALL:able-to-populate,L3)
...
* section[sectionHospitalCourse].section[sectionSynthesis] insert OblCreator(#SHALL:able-to-populate,L3)
* section[sectionHospitalCourse].section[sectionSynthesis].text insert OblCreator(#SHALL:able-to-populate,L3)
* section[sectionHospitalCourse].section[sectionSynthesis].entry insert OblCreator(#SHALL:able-to-populate,L3)
...
* section[sectionHospitalCourse].section[sectionDiagnosticSummary] insert OblConsumer(#SHALL:display,L3)
* section[sectionHospitalCourse].section[sectionDiagnosticSummary].text insert OblConsumer(#SHALL:display,L3)
* section[sectionHospitalCourse].section[sectionDiagnosticSummary].entry insert OblConsumer(#SHALL:display,L3)

* section[sectionHospitalCourse].section[sectionSignificantProcedures] insert OblConsumer(#SHALL:display,L3)
* section[sectionHospitalCourse].section[sectionSignificantProcedures].text insert OblConsumer(#SHALL:display,L3)
* section[sectionHospitalCourse].section[sectionSignificantProcedures].entry insert OblConsumer(#SHALL:display,L3)

* section[sectionHospitalCourse].section[sectionMedicalDevices] insert OblConsumer(#SHALL:display,L3)
* section[sectionHospitalCourse].section[sectionMedicalDevices].text insert OblConsumer(#SHALL:display,L3)
* section[sectionHospitalCourse].section[sectionMedicalDevices].entry insert OblConsumer(#SHALL:display,L3)

* section[sectionHospitalCourse].section[sectionPharmacotherapy] insert OblConsumer(#SHALL:display,L3)
* section[sectionHospitalCourse].section[sectionPharmacotherapy].text insert OblConsumer(#SHALL:display,L3)
* section[sectionHospitalCourse].section[sectionPharmacotherapy].entry insert OblConsumer(#SHALL:display,L3)

* section[sectionHospitalCourse].section[sectionSignificantResults] insert OblConsumer(#SHALL:display,L3)
* section[sectionHospitalCourse].section[sectionSignificantResults].text insert OblConsumer(#SHALL:display,L3)
* section[sectionHospitalCourse].section[sectionSignificantResults].entry insert OblConsumer(#SHALL:display,L3)
...
* section[sectionHospitalCourse].section[sectionSynthesis] insert OblConsumer(#SHALL:display,L3)
* section[sectionHospitalCourse].section[sectionSynthesis].text insert OblConsumer(#SHALL:display,L3)
* section[sectionHospitalCourse].section[sectionSynthesis].entry insert OblConsumer(#SHALL:display,L3)
